...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do 
      addresses = %w[user@foo,com user_at_foo.org example.user@foo. foo@ba_baz.com foo@bar+baz.com foo@bar..com]
  ...
  describe "micropost associations" do
    ...
    it "should have the right microposts in the right order" do
      expect(@user.microposts.to_a).to eq [newer_micropost, older_micropost] # user.microposts .to_a from its default state (which happens to be an Active Record “collection proxy”)
    end
